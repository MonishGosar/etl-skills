...
function mcpResult(client, data) {
...
export function createServer() {
    const server = new McpServer({ name: "etl-agent-tools", version: VERSION }, { capabilities: { tools: {} }, instructions: "Read-only ETL workspace inspection. Mutating operations are intentionally unavailable on this transport." });
    server.registerTool("etl_capabilities", {
    ...
    server.registerTool("etl_inspect", {
    ...
    server.registerTool("etl_query_status", {
